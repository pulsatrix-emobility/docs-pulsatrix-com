...
- `effectiveAmperageLimit` - *float* - Absolute amperage limit of the EVSE
...
<Tabs>
  ...
  <TabItem value="ws" label="WebSocket">
    ...
    {
    "topic": "transaction",
    "message": {"sessionId":"018ba9bc-5ebe-b235-e5fb-dba94e99767e","effectiveAmperageLimit":32, "state":"IDLE","startedTime":1699359776,"endedTime":1699359816,"meterStart":0.302999973,"meterStop":0.302999973,"vehicleStatus":"A","chargeControllerStatus":"A1","usedPhasesSession":"111","startReason":"Authorized","stopReason":"DeAuthorized","allocationSourceName":"OCPP Profile"}
    }
    ```
  </TabItem>
</Tabs>
