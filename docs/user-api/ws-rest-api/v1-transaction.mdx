...
- `startedTime` - *int* - time when the charge point started charging.  

- `endedTime` - *int* - time when the charge point stopped charging.  
...
- `allocationSourceName` - *String* - Name of the source currently in controll of the charging session.
