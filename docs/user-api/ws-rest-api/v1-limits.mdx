...
The `/limits` endpoint provides control functionality for the limits of the SECC.You can set the limits through the `SET` endpoint, and use a `GET` to get the current vaues set through the API.
